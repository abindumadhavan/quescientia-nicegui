...
@ui.page('/periodic_table', title='The Periodic Table')
def show():
    ui.markdown("""
    # Welcome to the Periodic Table!

    #### Explore the elements, their atomic structures, and how they combine to form molecules.
    - **Use the menu on the left to navigate through different sections** 
    - **Learn about each element by hovering over them in the periodic table**
    - **Discover atomic structures and molecular formations**
    """)
    ...
    ui.plotly(fig).classes('w-full h-[calc(100vh-20em)]')
